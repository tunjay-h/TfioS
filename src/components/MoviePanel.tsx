              ...
              <div className="mt-6 space-y-4 pr-6">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm">
                  <a
                    ...
                    className="rounded-full border border-white/20 px-4 py-2 font-medium text-white transition hover:border-aurum/70 hover:text-aurum focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
                  >
                    View on IMDb
                  </a>
                  <button
                    ...
                    className="rounded-full border border-white/10 px-4 py-2 font-medium text-white transition hover:border-aurum/60 hover:text-white focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
                  >
                    Share
                  </button>
                </div>
