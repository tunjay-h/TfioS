          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="rounded-full bg-white/10 px-3 py-1 text-sm text-white transition hover:bg-white/20 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
              >
                Close
              </button>
            </div>
            <div className="mt-4 overflow-hidden rounded-2xl border border-white/10 bg-black/40">
              {track.embedUrl ? (
                ...
                <div className="flex flex-col items-center gap-4 px-6 py-12 text-center text-starlight/90">
                  ...
                  <a
                    className="rounded-full bg-aurora/30 px-5 py-2 text-sm font-semibold text-white transition hover:bg-aurora/40 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
                    href={track.openUrl}
                    target="_blank"
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-4 text-sm text-starlight/80">
              <button
                ...
                className="rounded-full border border-white/10 px-4 py-2 font-medium transition hover:border-aurora/60 hover:text-white focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
              >
                Share
              </button>
