      ...
      <div className="flex max-w-md flex-col gap-2 rounded-2xl bg-white/5 p-4 text-sm text-starlight/90 backdrop-blur md:-mr-8">
        ...
        <div className="flex items-center gap-3 pt-2">
          <button
            ...
            className="rounded-full bg-aurora/20 px-4 py-2 text-sm font-semibold text-white backdrop-blur transition hover:bg-aurora/40 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
        ...
        {requiresUserStart ? (
          <button
            type="button"
            className="text-xs text-starlight/70 underline decoration-dotted underline-offset-2 hover:text-white focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aurora/70"
            onClick={onRetry}
          >
