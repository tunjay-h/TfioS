...
export function Header({
  ...
  return (
    <header className="relative z-10 flex flex-col gap-6 py-10 text-starlight md:flex-row md:items-end md:justify-between">
      <div className="space-y-3">
        ...
        <motion.p
          className="max-w-xl text-lg text-starlight/90"
      ...
      <div className="flex flex-col items-start gap-2 rounded-2xl bg-white/5 p-4 text-sm text-starlight/90 backdrop-blur md:items-end">
