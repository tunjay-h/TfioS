          ...
          return (
            <div key={movie.id} className="snap-start">
              <button
                ...
                className={`group relative flex w-52 flex-col overflow-hidden rounded-3xl border border-white/10 bg-black/30 text-left text-white shadow-xl transition focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-aurora/70 ${
